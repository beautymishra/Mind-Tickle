{
  ...
  "items": [
    {
      "exception": {
        "localizedMessage": "duplicate value found: Email__c duplicates value on record with id: a005i00000760Uy, poNumber__c duplicates value on record with id: a005i00000760Uy DUPLICATE_VALUE",
        "cause": null,
        "message": "duplicate value found: Email__c duplicates value on record with id: a005i00000760Uy, poNumber__c duplicates value on record with id: a005i00000760Uy DUPLICATE_VALUE",
        "stackTrace": [
          {
          ...
          },
          {
            "fileName": null,
            "methodName": "execute",
            "className": "org.mule.extension.salesforce.internal.operation.core.CreateOperation\$create\$MethodComponentExecutor_micorp_order_management_sys_api",
            "nativeMethod": false,
            "lineNumber": -1
          },
          {
      ...
      "message": "duplicate value found: Email__c duplicates value on record with id: a005i00000760Uy, poNumber__c duplicates value on record with id: a005i00000760Uy",
      "payload": {
        "success": false,
        "id": null,
        "errors": [
