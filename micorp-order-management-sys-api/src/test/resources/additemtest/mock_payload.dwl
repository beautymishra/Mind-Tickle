{
  ...
  "items": [
    {
      "exception": {
        "localizedMessage": "ORder: id value of incorrect type: a025i000006LJHvAAO FIELD_INTEGRITY_EXCEPTION",
        "cause": null,
        "message": "ORder: id value of incorrect type: a025i000006LJHvAAO FIELD_INTEGRITY_EXCEPTION",
        "stackTrace": [
          {
      ...
      "message": "ORder: id value of incorrect type: a025i000006LJHvAAO",
      "payload": {
        "success": false,
        "id": null,
        "errors": [
